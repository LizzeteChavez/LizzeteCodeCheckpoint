...
app.get('/consensus', function(req, res) {
    ...
    Promise.all(requestPromises)
        .then(blockchains => {
            ...
            const currentChainLength = bearcoin.chain.length;
            ...
            if (!newLongestChain || (newLongestChain && !bearcoin.chainIsValid(newLongestChain))) {
                res.json({
                    note: 'Current chain has not been replaced.',
                    chain: bearcoin.chain,
                });
                ...
                bearcoin.chain = newLongestChain;
                bearcoin.pendingTransactions = newPendingTransactions;
                res.json({
...
app.get('/block/:blockHash', function(req, res) {
    ...
    const correctBlock = bearcoin.getBlock(blockHash);
    res.json({
        block: correctBlock
    });
});
...
app.get('/transaction/:transactionId', function(req, res) {
    ...
    const transactionData = bearcoin.getTransaction(transactionId); //this gives us the t/x and the block as an object
    res.json({
...
app.get('/address/:address', function(req, res) {
    ...
    const addressData = bearcoin.getAddressData(address); //we get an object{} w t/x 
    res.json({
